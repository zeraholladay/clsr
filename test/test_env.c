...
static const char *test_env_similar_strings[] = {
    "example",  "exomple",   "exampl",    "exampel",   "exampqle", "exmple",
    "exaple",   "examnple",  "exmaple",   "examplex",  "exapmle",  "examplor",
    "exampole", "xample",    "examplely", "exambple",  "examp",    "exampler",
    "exampyle", "examplish", "examplerz", "exumple",   "exanpl",   "exampxel",
    "exampgle", "eximle",    "exadle",    "exanomple", "exnaple",  "examplyx",
    "exampole", "examplot",  "exumpole",  "zample",    "exemplar", "exawple",
    "eximpa",   "examplar",  "eximpyle",  "example"};
...
START_TEST(test_env_frame) {
  ...
  for (int i = 0; i < NUM_STRINGS; ++i) {
    void *hash = (void *)djb2(test_env_similar_strings[i]);
    ck_assert_int_eq(env_set(env_parent, test_env_similar_strings[i], hash), 0);
  }
